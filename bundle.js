...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventView = __webpack_require__(176);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WebAPIActions = __webpack_require__(160);

	var _WebAPIActions2 = _interopRequireDefault(_WebAPIActions);
	...
	var SearchBar = function (_React$Component) {
	    ...
	    _createClass(SearchBar, [{
	        ...
	        value: function onSubmit(e) {
	            ...
	            _WebAPIActions2.default.requestEvents(this.state.searchText);
	        }
	    }, {
	        key: 'calcInputStyle',
	        value: function calcInputStyle() {
	            var widthMultiplier = this.state.focus ? 0.5 : 0.3;
	            var style = {
	                fontSize: '1.5em',
	                display: 'block',
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        'Search for your favorite events or shows'
	                    )
	                ),
	                _react2.default.createElement(
	                    'form',
	                    { onSubmit: this.onSubmit.bind(this) },
	                    _react2.default.createElement('input', { style: this.calcInputStyle(), type: 'text', value: this.state.searchText, onChange: this.handleChange.bind(this), onFocus: this.handleFocus.bind(this), onBlur: this.handleBlur.bind(this) })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventbriteAPI = __webpack_require__(175);

	var _eventbriteAPI2 = _interopRequireDefault(_eventbriteAPI);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var WebAPIActions = function () {
	    function WebAPIActions() {
	        _classCallCheck(this, WebAPIActions);
	    }

	    _createClass(WebAPIActions, [{
	        key: 'requestEvents',
	        value: function requestEvents(search) {
	            var _this = this;

	            return function (dispatch) {
	                dispatch();
	                _eventbriteAPI2.default.fetch(search).then(function (events) {
	                    console.log('fetch complete');
	                    _this.updateEvents(events);
	        ...
	        key: 'requestFlights',
	        value: function requestFlights(dates) {
	            return dates;
	        }
	    }]);
	...
	exports.default = _alt2.default.createActions(WebAPIActions);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StateFunctions = __webpack_require__(166);
	...
	var _AltUtils = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPromise = __webpack_require__(174);
...
/***/ function(module, exports) {
	...
	var eventbriteAPI = {
	    fetch: function fetch(search) {
	        ...
	        var token = 'R5HDI3P2VFYNWBLDOY6Z';
	        var url = 'https://www.eventbriteapi.com/v3/events/search/?q=' + search + '&sort_by=best&expand=venue,organizer,ticket_classes';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _WebAPIStore = __webpack_require__(179);

	var _WebAPIStore2 = _interopRequireDefault(_WebAPIStore);
	...
	var EventView = function (_React$Component) {
	    ...
	    function EventView() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(EventView).apply(this, arguments));
	    }
	    ...
	    _createClass(EventView, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.events.map(function (event) {
	                    var img = '';
	                    if (event.logo) {
	                        img = _react2.default.createElement('img', { src: event.logo.url });
	                    }
	                    return _react2.default.createElement(
	                        'li',
	                        { key: event.id },
	        ...
	        value: function getStores() {
	            return [_WebAPIStore2.default];
	        }
	    }, {
	        key: 'getPropsFromStores',
	        value: function getPropsFromStores() {
	            return _WebAPIStore2.default.getState();
	        }
	    }]);
	...
	exports.default = (0, _connectToStores2.default)(EventView);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebAPIStore = function () {
	    function WebAPIStore() {
	        _classCallCheck(this, WebAPIStore);

	        this.bindListeners({
	            handleEvents: _WebAPIActions2.default.requestEvents,
	            handleUpdateEvents: _WebAPIActions2.default.updateEvents,
	            handleFlights: _WebAPIActions2.default.requestFlights
	        });
	    ...
	    _createClass(WebAPIStore, [{
	        ...
	        key: 'handleUpdateEvents',
	        value: function handleUpdateEvents(events) {
	            console.log('store_handleUpdateEvents');
	            this.setState({ events: events });
	        }
	    }, {
	        key: 'handleFlights',
	        value: function handleFlights(date) {
	...
	exports.default = _alt2.default.createStore(WebAPIStore, 'WebAPIStore');
